...
XenoGenesis-Sim is a Linux-first artificial-life sandbox for evolving digital organisms under customizable planetary conditions. It combines a production-grade continuous cellular automata (CA) engine, lightweight soft-body and digital-instruction substrates, evolutionary search tooling, and scripted workflows for analysis.
...
- **Outputs**: Parquet metrics, SQLite checkpoints plus compressed state blobs, plots, MP4/GIF renders, auto-generated reports.
...
- Use `--workers` to parallelize evaluations; OpenMP is enabled for native CA kernels.
